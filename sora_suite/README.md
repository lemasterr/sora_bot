...
> В `requirements.txt` теперь включены `PyQt6-Qt6`, `PyQt6-Qt6-DBus` и `PyQt6-Qt6-Data`, поэтому вместе с PyQt6 автоматически
> подтягиваются мультимедийные плагины Qt. После установки зависимости можно сразу пользоваться мини‑плеером предпросмотра
