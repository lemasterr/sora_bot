...
- Пути к папкам (downloads/blurred/merged, источники YouTube/TikTok и т.д.) всегда нормализуются относительно корня проекта, поэтому downloader, блюр и другие шаги работают с одними и теми же каталогами вне `workers/`.
