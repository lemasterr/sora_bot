...
const App: React.FC = () => {
  ...
  const sectionRefs = {
    pipeline: useRef<HTMLDivElement | null>(null),
    triggers: useRef<HTMLDivElement | null>(null),
    logs: useRef<HTMLDivElement | null>(null),
  } as const;
  ...
  const navItems = [
    { label: 'Pipeline', icon: Play, refKey: 'pipeline' as const },
    { label: 'Triggers', icon: Settings, refKey: 'triggers' as const },
    { label: 'Logs', icon: Terminal, refKey: 'logs' as const },
  ];
      ...
      <div className="grid min-h-screen grid-cols-[240px_1fr] overflow-hidden">
            ...
            <nav className="space-y-2 text-sm text-slate-300">
              {navItems.map((item) => (
                <button
                  ...
                  className="flex w-full items-center gap-2 rounded-lg border border-white/5 bg-white/5 px-3 py-2 text-left text-slate-200 shadow-sm shadow-black/30 transition hover:border-indigo-400/60 hover:bg-indigo-500/10"
                >
        ...
        <main className="relative flex flex-col overflow-hidden">
          ...
          <div className="relative grid flex-1 grid-cols-1 gap-6 overflow-y-auto px-4 py-6 md:grid-cols-[1.2fr_1fr] lg:px-8">
            <section ref={sectionRefs.pipeline} className="space-y-6">
              {!hasBridge && (
              ...
              <div ref={sectionRefs.logs} className="rounded-2xl border border-white/5 bg-white/5 p-6 shadow-xl shadow-black/30">
                <div className="flex items-center gap-2 text-sm font-semibold text-slate-100">
            ...
            <section ref={sectionRefs.triggers} className="space-y-4">
